...
Conformance is next for this: as soon as a second provider declares references, `packages/conformance` gains the fixture, because two providers meaning different things by one word is precisely what that package exists to prevent.
